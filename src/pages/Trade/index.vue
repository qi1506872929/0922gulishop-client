  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changDefault(address, userAddressList)">
...
export default {
  ...
  methods: {
    ...
    // 修改地址
    changDefault(address, userAddressList) {
    ...
    async submitOrder() {
      ...
      let tradeInfo = {
        ...
        deliveryAddress: this.userAddressList.fullAddress,
        paymentWay: "ONLINE",
  ...
  //   next((vm) => {
  //     // 通过 `vm` 访问组件实例
  //     if (from.path === "/shopcaart") {
  //       next();
  //     } else {
  //       vm.$message.error("只有从购物车界面才能跳转交易界面");
  //       next(false);
  //     }
  //   });
  // },
